...
% ----------------------------------- Chongxian's tech-----------------------------------------------------------------
\subsection{Technology 7: Machine Learning Libraries/Platforms to Train the Model}
% needed in second column of first page if using \IEEEpubid
%\IEEEpubidadjcol

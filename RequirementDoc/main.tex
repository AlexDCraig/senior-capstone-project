...
2.	Users then see a compilation of basketball statistics consisting of the categories ______ and select which statistics they want to train their model on. \\
3.   	The user is asked which machine learning algorithm out of the _____ they want to use. \\
4.      The statistics are passed to the machine learning algorithm which is computed using scikit. 
